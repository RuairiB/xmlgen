...
dofit(tasks, op, "pion1", 4, 35, tsgs, "LMDer", inputdir + "fits/pion32_onefit_PSQ4_tsgs_tmin" + str(4) + "tmax" + str(35) + "_jack.agr", 4, energies, "none", "Jackknife")
...
dofit(tasks, op, "eta1", 17, 25, tsse, "LMDer", inputdir + "fits/eta32_onefit_PSQ4_tsse_tmin" + str(17) + "tmax" + str(25) + "_jack.agr", 4, energies, "none", "Jackknife", "16")
...
dofit(tasks, op, "nucl1", 3, 25, tsgs, "LMDer", inputdir + "fits/nucleon32_onefit_PSQ4_tsgs_tmin" + str(3) + "tmax" + str(25) + "_jack.agr", 4, energies, "none", "Jackknife")
...
dofit(tasks, op, "kaon1", 4, 35, tsgs, "LMDer", inputdir + "fits/kaon32_onefit_PSQ4_tsgs_tmin" + str(4) + "tmax" + str(35) + "_jack.agr", 4, energies, "none", "Jackknife")
