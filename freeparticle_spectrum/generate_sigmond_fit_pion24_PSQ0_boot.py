...
logfile = inputdir + "log_fit_24_840_pion_du_meson_PSQ0_boot.log"
...
while tmax > 30:
    while tmin < (tmax - 6):
        dofit(tasks, "pion P=(0,0,0) A1um_1 SS_0", "pion", str(tmin), str(tmax), tsseC, "LMDer", inputdir + "fits/PSQ0/pion_24_840_PSQ0_tsseC_tmin" + str(tmin) + "tmax" + str(tmax) + "_boot.agr", "0", energies, "E1_ref_5_35P0tsgs", "Bootstrap")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 30:
    while tmin < (tmax - 15):
        dofit(tasks, "pion P=(0,0,0) A1um_1 SS_0", "pion", str(tmin), str(tmax), tsteC, "LMDer", inputdir + "fits/PSQ0/pion_24_840_PSQ0_tsteC_tmin" + str(tmin) + "tmax" + str(tmax) + "_boot.agr", "0", energies, "E1_ref_5_35P0tsgs", "Bootstrap")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 30:
    while tmin < (tmax - 15):
        dofit(tasks, "pion P=(0,0,0) A1um_1 SS_0", "pion", str(tmin), str(tmax), tsgs, "LMDer", inputdir + "fits/PSQ0/pion_24_840_PSQ0_tsgs_tmin" + str(tmin) + "tmax" + str(tmax) + "_boot.agr", "0", energies, "E1_ref_5_35P0tsgs", "Bootstrap")
        tmin+=1
    tmax-=1
    tmin=3

    
writesamplings(tasks, energies, inputdir + "energies/pion_24_840_PSQ0_boot", sampling="Bootstrap")
    
indent(root)
filename = str(inputdir + "input_fit_24_840_pion_du_meson_PSQ0_boot.xml")
tree.write(filename)
