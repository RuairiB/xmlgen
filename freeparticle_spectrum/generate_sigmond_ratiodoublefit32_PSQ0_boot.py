...
dofit(tasks, op, "pion1", 3, 35, tsgs, "LMDer", inputdir + "fits/pion32_onefit_PSQ0_tsgs_tmin" + str(3) + "tmax" + str(35) + "_boot.agr", 0, energies, "none", "Bootstrap")
...
dofit(tasks, op, "eta1", 17, 24, tsseC, "LMDer", inputdir + "fits/eta32_onefit_PSQ0_tsseC_tmin" + str(17) + "tmax" + str(24) + "_boot.agr", 0, energies, "none", "Bootstrap", "16")
...
dofit(tasks, op, "nucl1", 3, 24, tste, "LMDer", inputdir + "fits/nucleon32_onefit_PSQ0_tste_tmin" + str(3) + "tmax" + str(24) + "_boot.agr", 0, energies, "none", "Bootstrap")
...
dofit(tasks, op, "kaon1", 4, 35, tsgs, "LMDer", inputdir + "fits/kaon32_onefit_PSQ0_tsgs_tmin" + str(4) + "tmax" + str(35) + "_boot.agr", 0, energies, "none", "Bootstrap")
