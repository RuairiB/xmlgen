...
dofit(tasks, op, "pion1", 4, 35, tsgs, "LMDer", inputdir + "fits/pion32_onefit_PSQ1_tsgs_tmin" + str(4) + "tmax" + str(35) + "_jack.agr", 1, energies, Eref, "Jackknife")
...
dofit(tasks, op, "nucl1", 3, 25, tsgs, "LMDer", inputdir + "fits/nucleon32_onefit_PSQ1_tsgs_tmin" + str(3) + "tmax" + str(25) + "_jack.agr", 1, energies, Eref, "Jackknife")
...
dofit(tasks, op, "kaon1", 5, 34, tsgs, "LMDer", inputdir + "fits/kaon32_onefit_PSQ1_tsgs_tmin" + str(5) + "tmax" + str(34) + "_jack.agr", 1, energies, Eref, "Jackknife")
