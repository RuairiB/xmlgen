...
diagonalenergyplots(tasks, ops_psq2, inputdir + "plots/nucleon/diagcorr_24_840_uud_baryon_P2", "Jackknife")
diagonalenergyplots(tasks, ops_psq3, inputdir + "plots/nucleon/diagcorr_24_840_uud_baryon_P3", "Jackknife")
diagonalenergyplots(tasks, ops_psq4, inputdir + "plots/nucleon/diagcorr_24_840_uud_baryon_P4", "Jackknife")
diagonalenergyplots(tasks, ops_psq5, inputdir + "plots/nucleon/diagcorr_24_840_uud_baryon_P5", "Jackknife")
diagonalenergyplots(tasks, ops_psq6, inputdir + "plots/nucleon/diagcorr_24_840_uud_baryon_P6", "Jackknife")
    
indent(root)
filename = str(inputdir + "input_diagcorr_24_840_uud_baryon_nucleon.xml")
tree.write(filename)
