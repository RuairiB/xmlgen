...
diagonalenergyplots(tasks, ops_psq2, inputdir + "plots/kaon/diagcorr_32_860_su_meson_P2", "Jackknife")
diagonalenergyplots(tasks, ops_psq3, inputdir + "plots/kaon/diagcorr_32_860_su_meson_P3", "Jackknife")
diagonalenergyplots(tasks, ops_psq4, inputdir + "plots/kaon/diagcorr_32_860_su_meson_P4", "Jackknife")
diagonalenergyplots(tasks, ops_psq5, inputdir + "plots/kaon/diagcorr_32_860_su_meson_P5", "Jackknife")
diagonalenergyplots(tasks, ops_psq6, inputdir + "plots/kaon/diagcorr_32_860_su_meson_P6", "Jackknife")
    
indent(root)
filename = str(inputdir + "input_diagcorr_32_860_su_meson_kaon.xml")
tree.write(filename)
