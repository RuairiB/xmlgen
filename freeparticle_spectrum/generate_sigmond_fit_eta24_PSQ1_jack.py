...
while tmax > 20:
    while tmin < (tmax - 6):
        dofit(tasks, operator, "eta", str(tmin), str(tmax), tsseC, "LMDer", inputdir + "fits/PSQ1/eta_24_840_PSQ1_tsseC_tmin" + str(tmin) + "tmax" + str(tmax) + "_jack.agr", psq, energies, "E1_ref_5_35P0tsgs", "Jackknife", "16")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 20:
    while tmin < (tmax - 3):
        dofit(tasks, operator, "eta", str(tmin), str(tmax), tsteC, "LMDer", inputdir + "fits/PSQ1/eta_24_840_PSQ1_tsteC_tmin" + str(tmin) + "tmax" + str(tmax) + "_jack.agr", psq, energies, "E1_ref_5_35P0tsgs", "Jackknife", "16")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 20:
    while tmin < (tmax - 3):
        dofit(tasks, operator, "eta", str(tmin), str(tmax), tsse, "LMDer", inputdir + "fits/PSQ1/eta_24_840_PSQ1_tsse_tmin" + str(tmin) + "tmax" + str(tmax) + "_jack.agr", psq, energies, "E1_ref_5_35P0tsgs", "Jackknife", "16")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 20:
    while tmin < (tmax - 3):
        dofit(tasks, operator, "eta", str(tmin), str(tmax), tsgs, "LMDer", inputdir + "fits/PSQ1/eta_24_840_PSQ1_tsgs_tmin" + str(tmin) + "tmax" + str(tmax) + "_jack.agr", psq, energies, "E1_ref_5_35P0tsgs", "Jackknife", "16")
        tmin+=1
    tmax-=1
    tmin=3
