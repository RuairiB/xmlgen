...
def gen_aspect_fit(flav):
    ...
    proj_name = "anisotropy24_" + str(flav) + "_boot"
    inputdir = "/home/ruairi/research/freeparticle_energies/aspect_ratio/"
    logfile = inputdir + "log_anisotropy24_" + str(flav) + "_boot.log"
    ...
    plenty_fits = []
    for x in mucho_fits:
        if "24" in x.ensemble and x.sampling == "Bootstrap" and x.flav == flav: # and float(x.chisq_full) < 2.0:
