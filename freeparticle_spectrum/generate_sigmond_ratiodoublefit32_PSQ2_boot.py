...
dodoublefit(tasks, op, refop, "eta", "KrefE", 17, 25, 4, 35, tsse, tsgs, "LMDer", plotfile, 2, 0, "eta32_Kref_P2", energies, "Bootstrap", "16", exclude2="none", pivot="none", level="none")
dofit(tasks, op, "eta1", 17, 25, tsse, "LMDer", inputdir + "fits/eta32_onefit_PSQ2_tsse_tmin" + str(17) + "tmax" + str(25) + "_boot.agr", 2, energies, Eref, "Bootstrap", "16")
