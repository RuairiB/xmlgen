...
dofit(tasks, op, "pion1", 4, 35, tsgs, "LMDer", inputdir + "fits/pion32_onefit_PSQ2_tsgs_tmin" + str(4) + "tmax" + str(35) + "_boot.agr", 2, energies, "none", "Bootstrap")
...
dofit(tasks, op, "eta1", 17, 25, tsseC, "LMDer", inputdir + "fits/eta32_onefit_PSQ2_tsseC_tmin" + str(17) + "tmax" + str(25) + "_boot.agr", 2, energies, "none", "Bootstrap", "16")
...
dofit(tasks, op, "nucl1", 3, 25, tsgs, "LMDer", inputdir + "fits/nucleon32_onefit_PSQ2_tsgs_tmin" + str(3) + "tmax" + str(25) + "_boot.agr", 2, energies, "none", "Bootstrap")
...
dofit(tasks, op, "kaon1", 5, 35, tsgs, "LMDer", inputdir + "fits/kaon32_onefit_PSQ2_tsgs_tmin" + str(5) + "tmax" + str(35) + "_boot.agr", 2, energies, "none", "Bootstrap")
