...
corr_paths = ["/latticeQCD/raid6/ruairi/freeparticle_energies/irrep_averaging/avgbins/irrepavg_32_860_uud_baryons_PSQ0"]
...
while tmax > 20:
    while tmin < (tmax - 6):
        dofit(tasks, "GenIrreducible", operator, "nucleon", str(tmin), str(tmax), tsse, "Minuit2", inputdir + "fits/PSQ0/nucleon_32_860_PSQ0_tsse_tmin" + str(tmin) + "tmax" + str(tmax) + "_boot.agr", psq, energies, "E1_tmin8tmax34P0tsgs", "Bootstrap")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 20:
    while tmin < (tmax - 15):
        dofit(tasks, "GenIrreducible", operator, "nucleon", str(tmin), str(tmax), tste, "Minuit2", inputdir + "fits/PSQ0/nucleon_32_860_PSQ0_tste_tmin" + str(tmin) + "tmax" + str(tmax) + "_boot.agr", psq, energies, "E1_tmin8tmax34P0tsgs", "Bootstrap")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 20:
    while tmin < (tmax - 15):
        dofit(tasks, "GenIrreducible", operator, "nucleon", str(tmin), str(tmax), tsgs, "Minuit2", inputdir + "fits/PSQ0/nucleon_32_860_PSQ0_tsgs_tmin" + str(tmin) + "tmax" + str(tmax) + "_boot.agr", psq, energies, "E1_tmin8tmax34P0tsgs", "Bootstrap")
        tmin+=1
    tmax-=1
    tmin=3
