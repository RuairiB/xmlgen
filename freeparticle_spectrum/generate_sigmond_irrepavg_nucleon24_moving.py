...
operatoraverage(tasks, oplist, "isodoublet P=(0,0,1) G1_1 SS_0", inputdir + "avgbins/irrepavg_24_840_uud_baryons_PSQ1", 3, 40, True)

oplist = ["isodoublet P=(0,1,1) G_1 SS_0", "isodoublet P=(0,1,1) G_2 SS_0"]
operatoraverage(tasks, oplist, "isodoublet P=(0,1,1) G_1 SS_0", inputdir + "avgbins/irrepavg_24_840_uud_baryons_PSQ2", 3, 40, True)

oplist = ["isodoublet P=(1,1,1) G_1 SS_0", "isodoublet P=(1,1,1) G_2 SS_0"]
operatoraverage(tasks, oplist, "isodoublet P=(1,1,1) G_1 SS_0", inputdir + "avgbins/irrepavg_24_840_uud_baryons_PSQ3", 3, 40, True)

oplist = ["isodoublet P=(0,0,2) G1_1 SS_0", "isodoublet P=(0,0,2) G1_2 SS_0"]
operatoraverage(tasks, oplist, "isodoublet P=(0,0,2) G1_1 SS_0", inputdir + "avgbins/irrepavg_24_840_uud_baryons_PSQ4", 3, 40, True)

indent(root)
tree.write(inputdir + "input_irrepavg_nucleon24_moving.xml")
