...
while tmax > 30:
    while tmin < (tmax - 6):
        dofit(tasks, "kaon P=(0,0,0) A1u_1 SS_0", "kaon", str(tmin), str(tmax), tsse, "LMDer", inputdir + "fits/PSQ0/kaon_32_860_PSQ0_tsse_tmin" + str(tmin) + "tmax" + str(tmax) + "_jack.agr", "0", energies, "E1_kaon_4_35P0tsgs", "Jackknife")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 30:
    while tmin < (tmax - 15):
        dofit(tasks, "kaon P=(0,0,0) A1u_1 SS_0", "kaon", str(tmin), str(tmax), tste, "LMDer", inputdir + "fits/PSQ0/kaon_32_860_PSQ0_tste_tmin" + str(tmin) + "tmax" + str(tmax) + "_jack.agr", "0", energies, "E1_kaon_4_35P0tsgs", "Jackknife")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 30:
    while tmin < (tmax - 15):
        dofit(tasks, "kaon P=(0,0,0) A1u_1 SS_0", "kaon", str(tmin), str(tmax), tsgs, "LMDer", inputdir + "fits/PSQ0/kaon_32_860_PSQ0_tsgs_tmin" + str(tmin) + "tmax" + str(tmax) + "_jack.agr", "0", energies, "E1_kaon_4_35P0tsgs", "Jackknife")
        tmin+=1
    tmax-=1
    tmin=3
