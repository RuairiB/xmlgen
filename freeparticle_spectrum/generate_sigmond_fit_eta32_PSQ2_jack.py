...
while tmax > 20:
    while tmin < (tmax - 3):
        dofit(tasks, operator, "eta", str(tmin), str(tmax), tsse, "LMDer", inputdir + "fits/PSQ2/eta_32_860_PSQ2_tsse_tmin" + str(tmin) + "tmax" + str(tmax) + "_jack.agr", psq, energies, "E1_kaon_4_35P0tsgs", "Jackknife", "16")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 20:
    while tmin < (tmax - 10):
        dofit(tasks, operator, "eta", str(tmin), str(tmax), tste, "LMDer", inputdir + "fits/PSQ2/eta_32_860_PSQ2_tste_tmin" + str(tmin) + "tmax" + str(tmax) + "_jack.agr", psq, energies, "E1_kaon_4_35P0tsgs", "Jackknife", "16")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 20:
    while tmin < (tmax - 3):
        dofit(tasks, operator, "eta", str(tmin), str(tmax), tsseC, "LMDer", inputdir + "fits/PSQ2/eta_32_860_PSQ2_tsseC_tmin" + str(tmin) + "tmax" + str(tmax) + "_jack.agr", psq, energies, "E1_kaon_4_35P0tsgs", "Jackknife", "16")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 20:
    while tmin < (tmax - 3):
        dofit(tasks, operator, "eta", str(tmin), str(tmax), tsgs, "LMDer", inputdir + "fits/PSQ2/eta_32_860_PSQ2_tsgs_tmin" + str(tmin) + "tmax" + str(tmax) + "_jack.agr", psq, energies, "E1_kaon_4_35P0tsgs", "Jackknife", "16")
        tmin+=1
    tmax-=1
    tmin=3
