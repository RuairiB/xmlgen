...
refop = "kaon P=(0,0,0) A1u_1 SS_0"
plotfile = inputdir + "fits/pion32_PSQ3_doublefit_jack.agr"
dodoublefit(tasks, op, refop, "pion", "KrefP", 4, 35, 4, 35, tsgs, tsgs, "LMDer", plotfile, 3, 0, "pion32_Kref_P3", energies, "Jackknife", exclude1="none", exclude2="none", pivot="none", level="none")
dofit(tasks, op, "pion1", 4, 35, tsgs, "LMDer", inputdir + "fits/pion32_onefit_PSQ3_tsgs_tmin" + str(4) + "tmax" + str(35) + "_jack.agr", 3, energies, Eref, "Jackknife")


op = "isosinglet P=(1,1,1) A2p_1 SS_0"
refop = "kaon P=(0,0,0) A1u_1 SS_0"
plotfile = inputdir + "fits/eta32_PSQ3_doublefit_jack.agr"
dodoublefit(tasks, op, refop, "eta", "KrefE", 17, 25, 4, 35, tsse, tsgs, "LMDer", plotfile, 3, 0, "eta32_Kref_P3", energies, "Jackknife", "16", exclude2="none", pivot="none", level="none")
dofit(tasks, op, "eta1", 17, 25, tsse, "LMDer", inputdir + "fits/eta32_onefit_PSQ3_tsse_tmin" + str(17) + "tmax" + str(25) + "_jack.agr", 3, energies, Eref, "Jackknife", "16")


op = "isodoublet P=(1,1,1) G_1 SS_0"
refop = "kaon P=(0,0,0) A1u_1 SS_0"
plotfile = inputdir + "fits/nucleon32_PSQ3_doublefit_jack.agr"
dodoublefit(tasks, op, refop, "nucleon", "KrefN", 4, 25, 4, 35, tste, tsgs, "LMDer", plotfile, 3, 0, "nucleon32_Kref_P3", energies, "Jackknife", exclude1="none", exclude2="none", pivot="none", level="none")
dofit(tasks, op, "nucl1", 4, 25, tste, "LMDer", inputdir + "fits/nucleon32_onefit_PSQ3_tste_tmin" + str(4) + "tmax" + str(25) + "_jack.agr", 3, energies, Eref, "Jackknife")


op = "isodoublet P=(1,1,1) A2_1 SS_0"
refop = "kaon P=(0,0,0) A1u_1 SS_0"
plotfile = inputdir + "fits/kaon32_PSQ3_doublefit_jack.agr"
dodoublefit(tasks, op, refop, "kaon", "KrefK", 5, 35, 4, 35, tsgs, tsgs, "LMDer", plotfile, 3, 0, "kaon32_Kref_P3", energies, "Jackknife", exclude1="none", exclude2="none", pivot="none", level="none")
dofit(tasks, op, "kaon1", 5, 35, tsgs, "LMDer", inputdir + "fits/kaon32_onefit_PSQ3_tsgs_tmin" + str(5) + "tmax" + str(35) + "_jack.agr", 3, energies, Eref, "Jackknife")


indent(root)
filename = str(inputdir + "input_doublefit32_PSQ3_jack.xml")
tree.write(filename)
