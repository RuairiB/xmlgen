...
while tmax > 20:
    while tmin < (tmax - 6):
        dofit(tasks, "GenIrreducible", operator, "nucleon", str(tmin), str(tmax), tsseC, "Minuit2", inputdir + "fits/PSQ1/nucleon_24_840_PSQ1_tsseC_tmin" + str(tmin) + "tmax" + str(tmax) + "_boot.agr", psq, energies, "E1_ref_5_35P0tsgs", "Bootstrap")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 20:
    while tmin < (tmax - 10):
        dofit(tasks, "GenIrreducible", operator, "nucleon", str(tmin), str(tmax), tsteC, "Minuit2", inputdir + "fits/PSQ1/nucleon_24_840_PSQ1_tsteC_tmin" + str(tmin) + "tmax" + str(tmax) + "_boot.agr", psq, energies, "E1_ref_5_35P0tsgs", "Bootstrap")
        tmin+=1
    tmax-=1
    tmin=3
...
while tmax > 20:
    while tmin < (tmax - 10):
        dofit(tasks, "GenIrreducible", operator, "nucleon", str(tmin), str(tmax), tsgs, "Minuit2", inputdir + "fits/PSQ1/nucleon_24_840_PSQ1_tsgs_tmin" + str(tmin) + "tmax" + str(tmax) + "_boot.agr", psq, energies, "E1_ref_5_35P0tsgs", "Bootstrap")
        tmin+=1
    tmax-=1
    tmin=3
