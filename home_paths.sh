...
for f in $(find /home/ruairi/research/xmlgen/ -name '*.py'); do sed -i 's|/latticeQCD/raid8/laph/clover_s32|/home/ruairi/research/correlator_data/clover_s32|g' $f; done

for f in $(find /home/ruairi/research/xmlgen/ -name '*.py'); do sed -i 's|/latticeQCD/raid7/laph/clover_s24|/home/ruairi/research/correlator_data/clover_s24|g' $f; done
