...
rotatematrix(tasks, "SinglePivot", oplistP0, True, True, rotopP0, "pivotsingle_phi_rho_P0_boot", "0", "15", "0", "0", "1", inputdir + "pivots/pivotsingle_phi_rho_P0_0_0_1_boot", inputdir + "rotated_matrices/rotcorr_single_phi_rho_P0_0_0_1_boot", "Bootstrap", "TimeSymmetric", inputdir + "plots/phi_rho_singlepiv_P0_0_0_1_boot_level")

rotatematrix(tasks, "SinglePivot", oplistP1, True, False, rotopP1, "pivotsingle_phi_rho_P1_boot", "0", "15", "0", "0", "1", inputdir + "pivots/pivotsingle_phi_rho_P1_0_0_1_boot", inputdir + "rotated_matrices/rotcorr_single_phi_rho_P1_0_0_1_boot", "Bootstrap", "TimeSymmetric", inputdir + "plots/phi_rho_singlepiv_P1_0_0_1_boot_level")

# rotatematrix(tasks, "RollingPivot", oplistP0, True, True, rotopP0, "pivotrolling_phi_rho_P0_boot", "0", "15", "0", "0", "1", inputdir + "pivots/pivotrolling_phi_rho_P0_0_0_1_boot", inputdir + "rotated_matrices/rotcorr_rolling_phi_rho_P0_0_0_1_boot", "Bootstrap", "TimeSymmetric", inputdir + "plots/phi_rho_rollingpiv_P0_0_0_1_boot_level")

# rotatematrix(tasks, "RollingPivot", oplistP1, True, False, rotopP1, "pivotrolling_phi_rho_P1_boot", "0", "15", "0", "0", "1", inputdir + "pivots/pivotrolling_phi_rho_P1_0_0_1_boot", inputdir + "rotated_matrices/rotcorr_rolling_phi_rho_P1_0_0_1_boot", "Bootstrap", "TimeSymmetric", inputdir + "plots/phi_rho_rollingpiv_P1_0_0_1_boot_level")
