...
proj_name = "spectra32_jack"
inputdir = "/latticeQCD/raid6/ruairi/freeparticle_energies/spectra/"
logfile = inputdir + "log_spectra32_jack.log"
...
initialize(init, corr_paths, proj_name, logfile, "Jackknife", "32_860", "samplings", "True")
...
writesamplings(tasks, energies, inputdir + "energies/spectra32_jack", sampling="Jackknife")

indent(root)
filename = str(inputdir + "input_spectra32_jack.xml")
tree.write(filename)
