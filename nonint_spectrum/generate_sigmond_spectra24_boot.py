...
proj_name = "spectra24_boot"
inputdir = "/latticeQCD/raid6/ruairi/freeparticle_energies/spectra/"
logfile = inputdir + "log_spectra24_boot.log"
...
writesamplings(tasks, energies, inputdir + "energies/spectra24_boot", sampling="Bootstrap")

indent(root)
filename = str(inputdir + "input_spectra24_boot.xml")
tree.write(filename)
